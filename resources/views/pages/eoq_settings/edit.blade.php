    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('eoq_settings.update', $eoqSetting->id) }}" method="post"
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="number" id="ordering-cost" name="ordering_cost" placeholder="5000"
                                    class="form-control" value="{{ old('ordering_cost', $eoqSetting->ordering_cost) }}">
                                @error('ordering_cost')
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="number" id="storage-cost" name="storage_cost" placeholder="5000"
                                    class="form-control" value="{{ old('storage_cost', $eoqSetting->storage_cost) }}">
                                @error('storage_cost')
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="number" id="lead-time" name="lead_time" placeholder="5" class="form-control"
                                    value="{{ old('lead_time', $eoqSetting->lead_time) }}">
                                @error('lead_time')
                                    <small class="help-block form-text text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <a href="{{ route('eoq_settings.index') }}" class="btn btn-secondary btn-sm">

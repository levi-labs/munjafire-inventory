    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('stock_in.update', $stockIn->id) }}" method="post" class="form-horizontal">
                        @method('PUT')
                        @csrf
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="number" min="0" id="price" name="price" placeholder="0"
                                    class="form-control" value="{{ old('price') ?? formatNumber($stockIn->price) }}">
                                @error('price')
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="number" min="0" id="quantity" name="quantity" placeholder="0"
                                    class="form-control" value="{{ old('quantity', $stockIn->quantity) }}">
                                @error('quantity')
                                    <small class="help-block form-text text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <textarea name="description" id="description" rows="4" placeholder="Description" class="form-control">{{ $stockIn->description }}</textarea>
                                @error('description')
                                    <small class="help-block form-text text-danger">{{ $message }}</small>
                                @enderror
                            </div>

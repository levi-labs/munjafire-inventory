        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-6">
                            <a href="{{ route('stock_in.create') }}" class="btn btn-primary btn-sm">Add Stock In</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($stockIns as $stockIn)
                                <tr>
                                    ...
                                    <td>{{ $stockIn->date }}</td>
                                    <td>
                                        <a href="{{ route('stock_in.show', $stockIn->id) }}"
                                            class="btn btn-info btn-sm">Detail</a>
                                        <a href="{{ route('stock_in.edit', $stockIn->id) }}"
                                            class="btn btn-warning btn-sm">Edit</a>
                                        <form action="{{ route('stock_in.destroy', $stockIn->id) }}" method="POST"
